...
export default function AdminMembersScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              onAction={() => router.push('/(admin)/members/add')}
            />
          }
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: spacing.md }}>
                  ...
                  <View style={{ flex: 1 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacing.xs }}>
                      <Text style={{ color: colors.textPrimary, fontSize: fontSize.md, fontWeight: fontWeight.bold, flex: 1 }} numberOfLines={1}>
                        {item.full_name}
                      </Text>
                      <View style={{ flexDirection: 'row', gap: 4, alignItems: 'center' }}>
                        <Badge
                          label={item.role === 'admin' ? 'Admin' : 'Visitor'}
      ...
      {/* Floating Action Button (FAB) for Adding Member */}
      <TouchableOpacity
