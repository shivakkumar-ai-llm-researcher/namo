...
import { Contribution, Expense, CommunityFunction, FunctionType } from '../../src/types';
...
export default function VisitorDashboard() {
  ...
  const loadData = async () => {
    try {
      ...
      // Fetch all contributions and expenses
      const [allContribsRes, allExpensesRes] = await Promise.all([
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        <ProfileDropdownMenu variant="visitor" />
      </View>
      ...
      >
        ...
        <Card variant="default" style={{ flexDirection: 'row', alignItems: 'center', gap: spacing.md }}>
          ...
          <View>
            ...
            <Text style={{ color: colors.textPrimary, fontSize: fontSize.xl, fontWeight: fontWeight.bold }}>
              {summary.contributorCount} Active Contributors
            </Text>
          </View>
        </Card>

        {/* Quick Navigation Services (Members, Income, Expenses, Savings) */}
        <View style={{ gap: spacing.xs }}>
          <Text style={{ color: colors.textSecondary, fontSize: fontSize.xs, fontWeight: fontWeight.bold, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 2 }}>
            Community Services • விரைவு சேவைகள்
          </Text>
          <View style={{ flexDirection: 'row', gap: spacing.sm }}>
            {/* 1. Members */}
            <TouchableOpacity
              onPress={() => router.push('/(visitor)/members')}
              activeOpacity={0.75}
              style={{
                flex: 1,
                backgroundColor: colors.surface,
            ...
            {/* 2. Income */}
            <TouchableOpacity
              onPress={() => router.push('/(visitor)/contributions')}
              activeOpacity={0.75}
              style={{
                flex: 1,
                backgroundColor: colors.surface,
            ...
            {/* 3. Expenses */}
            <TouchableOpacity
              onPress={() => router.push('/(visitor)/expenses')}
              activeOpacity={0.75}
              style={{
                flex: 1,
                backgroundColor: colors.surface,
            ...
            {/* 4. Savings */}
            <TouchableOpacity
              onPress={() => router.push('/(visitor)/savings')}
              activeOpacity={0.75}
              style={{
                flex: 1,
                backgroundColor: colors.surface,
            ...
            >
              <View style={{ width: 38, height: 38, borderRadius: 19, backgroundColor: '#F5F3FF', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {/* Official Community Bank & UPI Scanner Card */}
        <View>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.sm }}>
            <Text style={{ color: colors.textPrimary, fontSize: fontSize.lg, fontWeight: fontWeight.bold }}>
              Direct Seva Contribution (காணிக்கை)
            </Text>
        ...
        <View>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing.md }}>
            ...
            <TouchableOpacity onPress={() => router.push('/(visitor)/contributions')}>
