...
export default function VisitorExpensesScreen() {
  ...
  const filtered = useMemo(() => {
    return expenses.filter((e) => {
      ...
      if (search.trim()) {
        ...
        if (!matchDesc && !matchCat && !matchRef && !matchFn) {
          return false;
        }
      }
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: spacing.xs }}>
          <View style={{ flex: 1 }}>
            <SearchBar
              ...
              placeholder="Search expenses, reference..."
            />
          </View>
          <TouchableOpacity
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              description="No expense records match your selected filters."
            />
          }
          renderItem={({ item }) => (
                ...
                <View style={{ alignItems: 'flex-end', marginLeft: spacing.sm }}>
                  ...
                  {item.receipt_url && (
                    ...
                    >
                      ...
                      <Text style={{ color: colors.primary, fontSize: fontSize.xs }}>Receipt</Text>
                    </TouchableOpacity>
                  )}
                </View>
              </View>
        ...
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.85)', justifyContent: 'center', alignItems: 'center', padding: spacing.lg }}>
          ...
          {selectedReceipt && (
            <Image
              ...
              style={{ width: '100%', height: '80%', borderRadius: borderRadius.md }}
              resizeMode="contain"
            />
          )}
        </View>
