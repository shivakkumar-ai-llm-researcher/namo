  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      <div>
        ...
        <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Financial Trends & Category Breakdown • நிதி பகுப்பாய்வு</p>
      </div>

      <Card>
        <h3 className="font-bold mb-4" style={{ color: 'var(--text-primary)' }}>Monthly Income vs Expenses</h3>
        {monthlyData.length === 0 ? (
          <p className="text-center py-8 text-sm" style={{ color: 'var(--text-secondary)' }}>No transactions available yet</p>
        ) : (
