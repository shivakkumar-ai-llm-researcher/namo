  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link
          href="/admin/functions/add"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-white text-sm font-semibold shadow-sm hover:opacity-90 transition-opacity self-start sm:self-auto"
          style={{ backgroundColor: 'var(--primary)', border: '1px solid #F59E0B' }}
        >
          <Plus size={16} /> Schedule Function
        </Link>
      </div>
        ...
        <div className="space-y-4">
          ...
          {loading ? (
            ...
            <EmptyState
              ...
              subtitle="No community functions scheduled for this year. Schedule an annual or 4-year function."
              action={
                <Link
                  href="/admin/functions/add"
                    ...
                    <Card className="p-4 hover:shadow-md transition-all">
                      <div className="flex items-start justify-between gap-3">
                        <div className="space-y-1.5 flex-1">
                          ...
                          <h4 className="text-base font-bold group-hover:text-amber-600 transition-colors" style={{ color: 'var(--text-primary)' }}>
                            {fn.name}
                          </h4>
                        ...
                        <div className="flex items-center justify-center w-8 h-8 rounded-full bg-black/5 dark:bg-white/5 flex-shrink-0 group-hover:bg-amber-100 dark:group-hover:bg-amber-950 transition-colors">
